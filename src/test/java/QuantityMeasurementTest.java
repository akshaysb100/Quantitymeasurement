...
public class QuantityMeasurementTest
{
   ...
   {
      QuantityMeasurement feet1 = new QuantityMeasurement(1.0, UnitConversion.Length.FEET);
      QuantityMeasurement feet2 = new QuantityMeasurement(1.0, UnitConversion.Length.FEET);
   ...
   {
      QuantityMeasurement feet1 = new QuantityMeasurement(1.0, UnitConversion.Length.FEET);
      QuantityMeasurement feet2 = new QuantityMeasurement(2.0,UnitConversion.Length.FEET);
   ...
   {
      QuantityMeasurement inch1 = new QuantityMeasurement(0.0,UnitConversion.Length.INCH);
      QuantityMeasurement inch2 = new QuantityMeasurement(0.0,UnitConversion.Length.INCH);
   ...
   {
      QuantityMeasurement inch1 = new QuantityMeasurement(0.0, UnitConversion.Length.INCH);
      QuantityMeasurement inch2 = new QuantityMeasurement(2.0,UnitConversion.Length.INCH);
   ...
   {
      QuantityMeasurement inch1 = new QuantityMeasurement(1.0, UnitConversion.Length.FEET);
      QuantityMeasurement feet1 = new QuantityMeasurement(1.0,UnitConversion.Length.INCH);
   ...
   public void comparingZeroInchAndZeroFeet_ShouldReturnEqualLength()
   {
      try
      {
         QuantityMeasurement inch1 = new QuantityMeasurement(0.0,UnitConversion.Length.FEET);
         QuantityMeasurement feet1 = new QuantityMeasurement(0.0,UnitConversion.Length.INCH);
   ...
   public void comparingZeroInchAnd1Feet_ShouldReturnNotEqualLength()
   {
      ...
      {
         QuantityMeasurement inch1 = new QuantityMeasurement(1.0, UnitConversion.Length.FEET);
         QuantityMeasurement feet1 = new QuantityMeasurement(4.0, UnitConversion.Length.INCH);
   ...
   public void givenOneFeetAndOneFeet_WhenCompered_ShouldReturnEqualLength()
   {
      try
      {
         QuantityMeasurement inch1 = new QuantityMeasurement(1.0, UnitConversion.Length.INCH_TO_FEET);
         QuantityMeasurement feet1 = new QuantityMeasurement(1.0,UnitConversion.Length.INCH);
         Boolean compareCheck = feet1.compare(inch1);
         Assert.assertFalse(compareCheck);
      }
   ...
   public void givenOneInchAndOneFeet_WhenCompered_ShouldReturnNotEqualLength()
   {
      ...
      {
         QuantityMeasurement inch1 = new QuantityMeasurement(1.0, UnitConversion.Length.INCH);
         QuantityMeasurement feet1 = new QuantityMeasurement(1.0, UnitConversion.Length.FEET_TO_INCH);
         Boolean compareCheck = feet1.compare(inch1);
         Assert.assertFalse(compareCheck);
      }
      catch (QuantityMeasurementException e)
   ...
   public void given36InchAndOneYard_WhenCompered_ShouldReturnTrue()
   {
      try
      {
         QuantityMeasurement inch1 = new QuantityMeasurement(36.0,UnitConversion.Length.INCH);
         QuantityMeasurement yard1 = new QuantityMeasurement(1.0,UnitConversion.Length.YARD);
         Boolean compareCheck = inch1.compare(yard1);
         Assert.assertTrue(compareCheck);
      }
      catch (QuantityMeasurementException e)
   ...
   public void givenOneFeetAnd3Yard_WhenCompered_ShouldReturnTrue()
   {
      ...
      {
         QuantityMeasurement feet1 = new QuantityMeasurement(1.0,UnitConversion.Length.FEET);
         QuantityMeasurement yard1 = new QuantityMeasurement(3.0,UnitConversion.Length.YARD_TO_FEET);
   ...
   public void given3FeetAndOneYard_WhenCompered_ShouldReturnTrue()
   {
      try
      {
         QuantityMeasurement feet1 = new QuantityMeasurement(3.0,UnitConversion.Length.FEET);
         QuantityMeasurement yard1 = new QuantityMeasurement(1.0,UnitConversion.Length.FEET_TO_YARD);
         Boolean compareCheck = feet1.compare(yard1);
         Assert.assertTrue(compareCheck);
      }
      catch (QuantityMeasurementException e)
